...
public class g_KeyBoardActions {
	...
	public static void main(String[] args) throws Exception
	{
		...
		act.moveToElement(element).click().sendKeys("mobiles").click().perform();
		Thread.sleep(2000);	
		
		//to click on search button
		driver.findElement(By.id("small-searchterms")).sendKeys("tv",Keys.ENTER);
		Thread.sleep(2000);
